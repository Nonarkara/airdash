...
import { emit, store } from './state.js?v=2.4.0'
import { tr, pick, BAND, LEVEL_NAME, pm25Level } from './i18n.js?v=2.4.0'
import { fmtNum, fmtClock, escapeHtml } from './fmt.js?v=2.4.0'
