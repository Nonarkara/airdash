...
import { on, emit, store, setLang } from './state.js?v=2.4.33'
import { paintChrome } from './i18n.js?v=2.4.33'
import { startTap } from './sse.js?v=2.4.33'
import { initMap, invalidateMap } from './map.js?v=2.4.33'
import { initHeader } from './panels/header.js?v=2.4.33'
import { initRanking } from './panels/ranking.js?v=2.4.33'
import { initForecast } from './panels/forecast.js?v=2.4.33'
import { initWhatIf } from './panels/whatif.js?v=2.4.33'
import { initDetail, hideDetail } from './panels/detail.js?v=2.4.33'
import { initTap } from './panels/tap.js?v=2.4.33'
import { initSources } from './panels/sources.js?v=2.4.33'
import { initHistory } from './panels/history.js?v=2.4.33'
import { initInsights } from './panels/insights.js?v=2.4.33'
import { initAnalytics } from './panels/analytics.js?v=2.4.33'
import { initFeeds } from './panels/feeds.js?v=2.4.33'
import { initChat } from './panels/chat.js?v=2.4.33'
import { initCitizen } from './panels/citizen.js?v=2.4.33'
import { initWaterways } from './panels/waterways.js?v=2.4.33'
import { initFocus } from './panels/focus.js?v=2.4.33'
import { initCityDashboard } from './panels/city-dashboard.js?v=2.4.33'
import { initSplit } from './panels/split.js?v=2.4.33'
import { initLibrary } from './panels/library.js?v=2.4.33'
import { initResearch } from './panels/research.js?v=2.4.33'
import { initManual } from './panels/manual.js?v=2.4.33'
import { initBurning } from './panels/burning.js?v=2.4.33'
import { initApiDocs } from './panels/apidocs.js?v=2.4.33'
import { initSearch } from './panels/search.js?v=2.4.33'
import { initDataFreshness } from './dataFreshness.js?v=2.4.33'
import { refreshSensorHealth } from './sensorHealth.js?v=2.4.33'
