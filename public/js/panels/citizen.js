...
import { el, fmtNum, ago } from '../fmt.js?v=2.0.0-audit5'
import { getJson } from '../cache.js?v=2.0.0-audit5'
import { flyToProvince } from '../map.js?v=2.0.0-audit5'
import { reliefEtaLine, worseBeforeBetterChip } from './patterns-ui.js?v=2.0.0-audit5'
      ...
      if (match) {
        ...
        try {
          ...
          if (match.lat != null && match.lng != null) {
            import('../map.js?v=2.0.0-audit5').then(({ flyToProvince }) => flyToProvince(match)).catch(() => {})
          }
        } catch {}
      }
    }
