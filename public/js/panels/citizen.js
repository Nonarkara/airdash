...
import { on, store, emit } from '../state.js?v=2.4.5'
import { tr, BAND } from '../i18n.js?v=2.4.5'
import { el, fmtNum, ago } from '../fmt.js?v=2.4.5'
import { getJson } from '../cache.js?v=2.4.5'
import { flyToProvince } from '../map.js?v=2.4.5'
import { sharePlace, copyText } from '../share.js?v=2.4.5'
import { reliefEtaLine, worseBeforeBetterChip } from './patterns-ui.js?v=2.4.5'
import {
      ...
      if (match) {
        ...
        try {
          ...
          if (match.lat != null && match.lng != null) {
            import('../map.js?v=2.4.5').then(({ flyToProvince }) => flyToProvince(match)).catch(() => {})
          }
        } catch {}
      }
    }
