...
import { on, store, emit } from '../state.js?v=2.0.0-fix1'
import { tr, BAND } from '../i18n.js?v=2.0.0-fix1'
import { el, fmtNum, ago } from '../fmt.js?v=2.0.0-fix1'
import { getJson } from '../cache.js?v=2.0.0-fix1'
import { flyToProvince } from '../map.js?v=2.0.0-fix1'
      ...
      if (match) {
        ...
        try {
          ...
          if (match.lat != null && match.lng != null) {
            import('../map.js?v=2.0.0-fix1').then(({ flyToProvince }) => flyToProvince(match)).catch(() => {})
          }
        } catch {}
      }
    }
