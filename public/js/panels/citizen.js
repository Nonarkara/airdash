...
import { el, fmtNum, ago } from '../fmt.js?v=2.4.4'
import { getJson } from '../cache.js?v=2.4.4'
import { flyToProvince } from '../map.js?v=2.4.4'
import { sharePlace, copyText } from '../share.js?v=2.4.4'
import { reliefEtaLine, worseBeforeBetterChip } from './patterns-ui.js?v=2.4.4'
import {
      ...
      if (match) {
        ...
        try {
          ...
          if (match.lat != null && match.lng != null) {
            import('../map.js?v=2.4.4').then(({ flyToProvince }) => flyToProvince(match)).catch(() => {})
          }
        } catch {}
      }
    }
