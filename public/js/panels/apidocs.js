...
import { store, on } from '../state.js?v=2.4.29'
  ...
  return [
    {
      ...
      rows: [
        ...
        { path: '/api/risk', cache: tr('1 นาที', '1 min'),
          ...
          note_th: 'reasons ใน card คือหลักฐานที่ทำให้ได้แบนด์นี้ — แสดงต่อผู้ใช้ อย่าแสดงแค่ตัวเลข',
          note_en: 'card.reasons is the evidence behind the band — show it to people, never the number alone.' },
