...
import { on, emit, store } from '../state.js?v=2.0.0-bcast1'
import { tr } from '../i18n.js?v=2.0.0-bcast1'
import { fmtNum } from '../fmt.js?v=2.0.0-bcast1'
import { getJson } from '../cache.js?v=2.0.0-bcast1'
import { drawBarChart, drawDonut } from '../chart.js?v=2.0.0-bcast1'
import { nationalPatternsBlock } from './patterns-ui.js?v=2.0.0-bcast1'
