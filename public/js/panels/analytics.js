...
import { on, emit, store } from '../state.js?v=2.4.13'
import { tr } from '../i18n.js?v=2.4.13'
import { fmtNum } from '../fmt.js?v=2.4.13'
import { getJson } from '../cache.js?v=2.4.13'
import { drawBarChart, drawDonut } from '../chart.js?v=2.4.13'
import { nationalPatternsBlock } from './patterns-ui.js?v=2.4.13'
