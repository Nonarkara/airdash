...
import { on, store, setLang } from '../state.js?v=2.0.0-line1'
import { tr } from '../i18n.js?v=2.0.0-line1'
import { openInsightsPane } from '../sensorHealth.js?v=2.0.0-line1'
import { riskCi } from '../confidence.js?v=2.0.0-line1'
import { getJson } from '../cache.js?v=2.0.0-line1'
import { flyToProvince } from '../map.js?v=2.0.0-line1'
import { showProvinceDetail } from './detail.js?v=2.0.0-line1'
