...
import { on, store, setLang } from '../state.js?v=2.4.6'
import { tr } from '../i18n.js?v=2.4.6'
import { openInsightsPane } from '../sensorHealth.js?v=2.4.6'
import { riskCi } from '../confidence.js?v=2.4.6'
