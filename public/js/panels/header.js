...
import { on, store, setLang } from '../state.js?v=2.4.18'
import { tr } from '../i18n.js?v=2.4.18'
import { openInsightsPane } from '../sensorHealth.js?v=2.4.18'
import { riskCi } from '../confidence.js?v=2.4.18'
