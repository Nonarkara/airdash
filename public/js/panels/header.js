...
import { on, store, setLang } from '../state.js?v=2.4.19'
import { tr } from '../i18n.js?v=2.4.19'
import { openInsightsPane } from '../sensorHealth.js?v=2.4.19'
import { riskCi } from '../confidence.js?v=2.4.19'
import { getJson } from '../cache.js?v=2.4.19'
import { flyToProvince } from '../map.js?v=2.4.19'
import { showProvinceDetail } from './detail.js?v=2.4.19'
