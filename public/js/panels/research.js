...
import { on, store } from '../state.js?v=2.4.23'
import { getJson } from '../cache.js?v=2.4.23'
import { escapeHtml } from '../fmt.js?v=2.4.23'
...
function sectionWhy() {
  // Section 1 — Why AirDash exists. A short academic motivation only.
  // The full personal story — with photographs — lives in the About
  // pane's "Why this is personal" section; this paper points to it
  // instead of reproducing it, so the two panes stay complementary
  // rather than duplicating the same essay twice.
  return `
    <section class="rp-section rp-section-why">
      ...
      <p data-th="AirDash เกิดจากประสบการณ์ตรงของผู้เขียนกับผลกระทบของมลพิษทางอากาศ — ทั้งการสูญเสียบุคคลในครอบครัวจากปัญหาสุขภาพที่เชื่อมโยงกับอากาศไม่ดีในกรุงเทพฯ ต่อเนื่องหลายปี และการใช้ชีวิตผ่านวิกฤตฝุ่นครั้งรุนแรงที่สุดครั้งหนึ่งของเซี่ยงไฮ้ (2013–2016) เรื่องราวฉบับเต็มพร้อมภาพประกอบอยู่ในแท็บ 'เกี่ยวกับ' — หัวข้อนี้เก็บไว้เฉพาะแรงจูงใจที่นำไปสู่สถาปัตยกรรมและวิธีวิทยาที่อธิบายในหัวข้อถัดไป" data-en="AirDash grew out of the author's direct experience with air pollution's health impact — a family loss linked to years of poor air quality in Bangkok, and living through one of Shanghai's worst dust crises (2013–2016). The full personal account, with photographs, lives in the About tab; this section keeps only the motivation that shaped the architecture and methodology described below.">
        ${tr(
          'AirDash เกิดจากประสบการณ์ตรงของผู้เขียนกับผลกระทบของมลพิษทางอากาศ เรื่องราวฉบับเต็มพร้อมภาพประกอบอยู่ในแท็บ "เกี่ยวกับ" — หัวข้อนี้เก็บไว้เฉพาะแรงจูงใจที่นำไปสู่สถาปัตยกรรมและวิธีวิทยาที่อธิบายด้านล่าง',
          'AirDash grew out of the author\'s direct experience with air pollution\'s health impact. The full personal account, with photographs, lives in the About tab — this section keeps only the motivation that shaped the architecture and methodology below.'
        )}
      </p>

      <p data-th="สามข้อสัญญาการออกแบบที่ตามมาจากประสบการณ์นี้ — ลงมือทำเองแทนที่จะรอภาครัฐ ยึดว่าอากาศบริสุทธิ์เป็นสิทธิขั้นพื้นฐาน และมองว่าเรื่องนี้เร่งด่วนกว่าโลกร้อนเพราะฝุ่นฆ่าคนได้ในระยะสั้น — อธิบายไว้ละเอียดในแท็บ 'เกี่ยวกับ' เช่นกัน" data-en="The three design commitments that followed — build it yourself rather than wait for government, treat clean air as a basic right, and treat this as more urgent than climate change because dust kills on a short timescale — are likewise detailed in the About tab.">
        ${tr(
          'สามข้อสัญญาการออกแบบที่ตามมาจากประสบการณ์นี้อธิบายไว้ละเอียดในแท็บ "เกี่ยวกับ" เช่นกัน',
          'The three design commitments that followed are likewise detailed in the About tab.'
        )}
      </p>
    </section>`
}
