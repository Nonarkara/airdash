...
import { tr, BAND, pm25Level, LEVEL_NAME } from '../i18n.js?v=2.4.24'
import { fmtNum, el } from '../fmt.js?v=2.4.24'
import { flyToProvince } from '../map.js?v=2.4.24'
import { showProvinceDetail } from './detail.js?v=2.4.24'
import { causeChip, causesByProvince, causeEvidenceBlock } from './patterns-ui.js?v=2.4.24'
