...
import { tr, pick } from '../i18n.js?v=2.0.0-hero1'
import { fmtNum, fmtClock, el } from '../fmt.js?v=2.0.0-hero1'
import { flyToStation } from '../map.js?v=2.0.0-hero1'
import { drawSeriesChart } from '../chart.js?v=2.0.0-hero1'
import { provinceHealth } from '../sensorHealth.js?v=2.0.0-hero1'
import { causeChip, causesByProvince, causeEvidenceBlock, provincePatternsBlock } from './patterns-ui.js?v=2.0.0-hero1'
