...
import { fmtNum, fmtClock, el } from '../fmt.js?v=2.0.0-i18n1'
import { flyToStation } from '../map.js?v=2.0.0-i18n1'
import { drawSeriesChart } from '../chart.js?v=2.0.0-i18n1'
import { provinceHealth } from '../sensorHealth.js?v=2.0.0-i18n1'
