...
import { tr, pick } from '../i18n.js?v=2.4.30'
import { fmtNum, fmtClock, el } from '../fmt.js?v=2.4.30'
import { flyToStation } from '../map.js?v=2.4.30'
import { drawSeriesChart } from '../chart.js?v=2.4.30'
import { provinceHealth } from '../sensorHealth.js?v=2.4.30'
import { causeChip, causesByProvince, causeEvidenceBlock, provincePatternsBlock } from './patterns-ui.js?v=2.4.30'
