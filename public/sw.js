...
const CACHE = 'airdash-v48';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.30',
  '/css/layout.css?v=2.4.30',
  '/css/components.css?v=2.4.30',
  '/css/city-dashboard.css?v=2.4.30',
  '/css/story.css?v=2.4.30',
  '/js/boot.js?v=2.4.30',
  '/js/panels/burning.js?v=2.4.30',
  '/js/main.js?v=2.4.30',

  '/js/feedAge.js?v=2.4.30',
  '/js/story.js?v=2.4.30',
  ...
  '/js/panels/citizenLife.js?v=2.4.30',
