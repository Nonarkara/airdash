...
const CACHE = 'airdash-v29';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.5',
  '/css/layout.css?v=2.4.5',
  '/css/components.css?v=2.4.5',
  '/css/city-dashboard.css?v=2.4.5',
  '/css/story.css?v=2.4.5',
  '/js/main.js?v=2.4.5',
  '/js/story.js?v=2.4.5',
  ...
  '/js/panels/citizenLife.js?v=2.4.5',
