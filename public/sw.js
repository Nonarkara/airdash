...
const PRECACHE_URLS = [
  ...
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.6',
  '/css/layout.css?v=2.4.6',
  '/css/components.css?v=2.4.6',
  '/css/city-dashboard.css?v=2.4.6',
  '/css/story.css?v=2.4.6',
  '/js/main.js?v=2.4.6',
  '/js/story.js?v=2.4.6',
  ...
  '/js/panels/citizenLife.js?v=2.4.6',
