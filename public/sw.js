...
const CACHE = 'airdash-v40';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.22',
  '/css/layout.css?v=2.4.22',
  '/css/components.css?v=2.4.22',
  '/css/city-dashboard.css?v=2.4.22',
  '/css/story.css?v=2.4.22',
  '/js/main.js?v=2.4.22',

  '/js/feedAge.js?v=2.4.22',
  '/js/story.js?v=2.4.22',
  ...
  '/js/panels/citizenLife.js?v=2.4.22',
