...
const CACHE = 'airdash-v44';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.26',
  '/css/layout.css?v=2.4.26',
  '/css/components.css?v=2.4.26',
  '/css/city-dashboard.css?v=2.4.26',
  '/css/story.css?v=2.4.26',
  '/js/boot.js?v=2.4.26',
  '/js/panels/burning.js?v=2.4.26',
  '/js/main.js?v=2.4.26',

  '/js/feedAge.js?v=2.4.26',
  '/js/story.js?v=2.4.26',
  ...
  '/js/panels/citizenLife.js?v=2.4.26',
