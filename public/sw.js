...
const CACHE = 'airdash-v5';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/css/tokens.css?v=2.0.0-fix1',
  '/css/layout.css?v=2.0.0-fix1',
  '/css/components.css?v=2.0.0-fix1',
  '/css/city-dashboard.css?v=2.0.0-fix1',
  '/js/main.js?v=2.0.0-fix1',
