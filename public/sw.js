...
const CACHE = 'airdash-v20';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/css/tokens.css?v=2.0.0-audit4',
  '/css/layout.css?v=2.0.0-audit4',
  '/css/components.css?v=2.0.0-audit4',
  '/css/city-dashboard.css?v=2.0.0-audit4',
  '/js/main.js?v=2.0.0-audit4',
