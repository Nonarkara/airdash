...
const CACHE = 'airdash-v30';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.13',
  '/css/layout.css?v=2.4.13',
  '/css/components.css?v=2.4.13',
  '/css/city-dashboard.css?v=2.4.13',
  '/css/story.css?v=2.4.13',
  '/js/main.js?v=2.4.13',
  '/js/story.js?v=2.4.13',
  ...
  '/js/panels/citizenLife.js?v=2.4.13',
