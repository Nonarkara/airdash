...
const CACHE = 'airdash-v14';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/css/tokens.css?v=2.0.0-tg1',
  '/css/layout.css?v=2.0.0-tg1',
  '/css/components.css?v=2.0.0-tg1',
  '/css/city-dashboard.css?v=2.0.0-tg1',
  '/js/main.js?v=2.0.0-tg1',
