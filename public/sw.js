...
const CACHE = 'airdash-v19';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/css/tokens.css?v=2.0.0-audit3',
  '/css/layout.css?v=2.0.0-audit3',
  '/css/components.css?v=2.0.0-audit3',
  '/css/city-dashboard.css?v=2.0.0-audit3',
  '/js/main.js?v=2.0.0-audit3',
