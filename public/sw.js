...
const CACHE = 'airdash-v23';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.0.0-fresh1',
  '/css/layout.css?v=2.0.0-fresh1',
  '/css/components.css?v=2.0.0-fresh1',
  '/css/city-dashboard.css?v=2.0.0-fresh1',
