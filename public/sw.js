...
const CACHE = 'airdash-v10';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/css/tokens.css?v=2.0.0-heatmap1',
  '/css/layout.css?v=2.0.0-heatmap1',
  '/css/components.css?v=2.0.0-heatmap1',
  '/css/city-dashboard.css?v=2.0.0-heatmap1',
  '/js/main.js?v=2.0.0-heatmap1',
