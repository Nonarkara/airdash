...
const CACHE = 'airdash-v39';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.21',
  '/css/layout.css?v=2.4.21',
  '/css/components.css?v=2.4.21',
  '/css/city-dashboard.css?v=2.4.21',
  '/css/story.css?v=2.4.21',
  '/js/main.js?v=2.4.21',

  '/js/feedAge.js?v=2.4.21',
  '/js/story.js?v=2.4.21',
  ...
  '/js/panels/citizenLife.js?v=2.4.21',
