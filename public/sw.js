...
const CACHE = 'airdash-v50';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.32',
  '/css/layout.css?v=2.4.32',
  '/css/components.css?v=2.4.32',
  '/css/city-dashboard.css?v=2.4.32',
  '/css/story.css?v=2.4.32',
  '/js/boot.js?v=2.4.32',
  '/js/panels/burning.js?v=2.4.32',
  '/js/main.js?v=2.4.32',

  '/js/feedAge.js?v=2.4.32',
  '/js/story.js?v=2.4.32',
  ...
  '/js/panels/citizenLife.js?v=2.4.32',
