...
const CACHE = 'airdash-v15';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/css/tokens.css?v=2.0.0-bcast1',
  '/css/layout.css?v=2.0.0-bcast1',
  '/css/components.css?v=2.0.0-bcast1',
  '/css/city-dashboard.css?v=2.0.0-bcast1',
  '/js/main.js?v=2.0.0-bcast1',
