...
const CACHE = 'airdash-v49';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.31',
  '/css/layout.css?v=2.4.31',
  '/css/components.css?v=2.4.31',
  '/css/city-dashboard.css?v=2.4.31',
  '/css/story.css?v=2.4.31',
  '/js/boot.js?v=2.4.31',
  '/js/panels/burning.js?v=2.4.31',
  '/js/main.js?v=2.4.31',

  '/js/feedAge.js?v=2.4.31',
  '/js/story.js?v=2.4.31',
  ...
  '/js/panels/citizenLife.js?v=2.4.31',
