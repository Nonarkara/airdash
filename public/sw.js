...
const CACHE = 'airdash-v16';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/css/tokens.css?v=2.0.0-muni1',
  '/css/layout.css?v=2.0.0-muni1',
  '/css/components.css?v=2.0.0-muni1',
  '/css/city-dashboard.css?v=2.0.0-muni1',
  '/js/main.js?v=2.0.0-muni1',
