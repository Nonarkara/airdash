...
const CACHE = 'airdash-v51';

const PRECACHE_URLS = [
  '/',
  '/index.html',
  '/ops.html',
  '/css/tokens.css?v=2.4.33',
  '/css/layout.css?v=2.4.33',
  '/css/components.css?v=2.4.33',
  '/css/city-dashboard.css?v=2.4.33',
  '/css/story.css?v=2.4.33',
  '/js/boot.js?v=2.4.33',
  '/js/panels/burning.js?v=2.4.33',
  '/js/main.js?v=2.4.33',

  '/js/feedAge.js?v=2.4.33',
  '/js/story.js?v=2.4.33',
  ...
  '/js/panels/citizenLife.js?v=2.4.33',
